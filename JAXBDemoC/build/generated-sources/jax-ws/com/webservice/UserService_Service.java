 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://webService.com/", wsdlLocation = "http://localhost:8080/JAXBDemo/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://webService.com/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/JAXBDemo/UserService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://webService.com/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webService.com/", "UserServicePort"), UserService.class, features);
    }
