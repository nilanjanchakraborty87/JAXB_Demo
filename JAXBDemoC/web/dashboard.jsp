...
<base href="<%=basePath%>">
<!DOCTYPE html>
<%@ page import="org.netbeans.xml.schema.user.*"%>
<html lang="en">
    <head>
        <meta charset="utf-8">
                        ...
                        <div class="col-lg-offset-2 col-lg-8">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody >
                                    ...
                                    <tr><td>First Name:</td><td><%=infoList.get(i).getName().getFirstName()%></td></tr>
                                    <tr><td>Last Name:</td><td><%=infoList.get(i).getName().getLastName()%></td></tr>
                                     <tr><td>Birth Year:</td><td><%=infoList.get(i).getBirth().getBirthYear()%></td></tr>
                                     <tr><td>Birth Month:</td><td><%=infoList.get(i).getBirth().getBirthMonth()%></td></tr>
                                    <%}
                                    }%>
                                </tbody>
                            </table>
